...
//		AVLNode* right;
//
//		AVLNode(T data, Node<User>* userAddress, AVLNode* left = nullptr, AVLNode* right = nullptr) : data(data), height(0), left(left), right(right) {
//			userAddresses.insertAtEnd(userAddress);
//		}
//	};
//
//	AVLNode* root;
...
//
//		//if (!countryAVLNode) {
//		//	countryGrpIdx.insert(userCountry);
...
//
//		if (!node) {
//			auto userAddressInDLL = users.insertHead(user);
...
//		if (!user) {
//			cout << "User with the given name does not exist" << endl;
//			return;
//		}
//		else {
//			printUser(user->userAddresses.getHead()->value->data);
...
//		if (!user) {
//			cout << "User with the given email does not exist" << endl;
//			return;
//		}
//		else {
//			printUser(user->userAddresses.getHead()->value->data);
